export const environment = {
  ...
  // Aktif ayar adı
  setting: 'tau', // 'ordu' | 'afyon' | 'turkAlman' | 'tskb' | 'eureko' | 'nurol' | 'gatement' | 'development'
  ...
  themes: {
    ...
    tau: {
      // Primary renk (Ana renk) - Logo turkuaz/teal (#00B4BD - TÜRK-ALMAN metni ve yaprak vurgusu)
      primary: '#00B4BD',
      primaryFixedDim: 'rgba(0, 180, 189, 0.15)',
      // Secondary renk (İkincil renk) - Logo koyu gri (#383B40 - monogram ve TÜRKISCH-DEUTSCHE metni)
      secondary: '#383B40',
      ...
      success: '#36c76c',
      successFixedDim: '#36c76c26',
      // Tertiary renk - Açık turkuaz/gri arka plan tonu
      tertiary: '#E8F6F7',
