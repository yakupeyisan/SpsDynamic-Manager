...
export const formFields: TableColumn[] = [
  ...
  { 
    ...
    render: (record: any) => {
      ...
      return getPaymentTypeText(record['PaymentType']);
    }
  },
  { 
...
export const formTabs: FormTab[] = [
  { 
    label: 'Tahsilat Bilgileri', 
    fields: ['Id', 'Employee.IdentificationNumber', 'Employee.Name', 'Employee.SurName', 'Employee.EmployeeDepartments', 'Account.AccountName', 'Amount', 'PaymentType', 'MeansOfPayment', 'ResultStatus', 'Description', 'Provision', 'TransactionId', 'IsCancel'] 
  }
];
