// PayStationLogs form configuration
...
// Form load request - not needed for pay station logs (read-only)
export const formLoadRequest = undefined;

// Form data mapper - not needed for pay station logs (read-only)
